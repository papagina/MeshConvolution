...
pc_seqs1 = get_pc_seqs_from_DFAUST("../../../data/D-FAUST/registrations_f.hdf5")
pc_seqs2 = get_pc_seqs_from_DFAUST("../../../data/D-FAUST/registrations_m.hdf5")

pc_seqs = pc_seqs1 + pc_seqs2

print ("Load", len(pc_seqs1), "+", len(pc_seqs2),"model sequences in total.")

train_fn ="../../data/D-FAUST_harder/train"
eval_fn ="../../data/D-FAUST_harder/eval"
test_fn ="../../data/D-FAUST_harder/test"

mean_fn = "../../data/D-FAUST_harder/mean"
std_fn = "../../data/D-FAUST_harder/std"
